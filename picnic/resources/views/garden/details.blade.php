...
@section('title',  trans('messages.tltGardenDetails'))
        ...
        <div class="fluid-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="page-section" id="about">
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="widget-title" style="color: black">گالری تصاویر</h4>
                ...
                <div class="page-section" id="projects" dir="rtl">
                    <div class="row" dir="rtl">
                        <div class="col-md-12" dir="rtl">
                            <h4 class="widget-title" style="color: black"> امکانات</h4>
                            <p></p>
                            <br>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12" id="featuresListIcons">
                            <div class="col-sm-4">
                                ...
                                @if($features->building && (strcmp($features->building_description,'ندارد')!=0))
                                    <span>{{trans('messages.lblBuilding')}}
                                ...
                                @elseif($features->building && (strcmp($features->building_description,'ندارد')==0) )
                                    <span id="myPopup13">{{trans('messages.lblBuilding')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @elseif (($features->garage_open || $features->garage_open) && (strcmp($features->garage_description,'ندارد')==0))
                                    <span id="myPopup2">{{trans('messages.lblGarage')}}</span>
                            ...
                            <div class="col-sm-4">
                                ...
                                @elseif($features->arbour && (strcmp($features->arbour_description,'ندارد')==0) )
                                    <span id="myPopup3">{{trans('messages.lblArbour')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->terrace && (strcmp($features->terrace_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblTerrace')}}
...
{{--                                     <p>{{trans('messages.lblHave')}}</p>--}}
                                ...
                                @elseif($features->terrace && (strcmp($features->terrace_description,'ندارد')==0) )
                                    <span id="myPopup4">{{trans('messages.lblTerrace')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->bathroom && (strcmp($features->bathroom_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblBathroom')}}
                                ...
                                @elseif($features->bathroom && (strcmp($features->bathroom_description,'ندارد')==0) )
                                    <span id="myPopup5">{{trans('messages.lblBathroom')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @elseif(($features->wc_western || $features->wc_persian) && (strcmp($features->wc_description,'ندارد')==0) )
                                    <span id="myPopup6">{{trans('messages.lblWC')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @elseif(($features->pool_covered || $features->pool_open) && (strcmp($features->pool_description,'ندارد')==0) )
                                    <span id="myPopup7" class="">{{trans('messages.lblPool')}}</span>
                                @else
...
{{--                                            {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->sauna && (strcmp($features->sauna_description,'ندارد')==0) )
                                    <span id="myPopup8" class="">{{trans('messages.lblSauna')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->jacuzzi && (strcmp($features->jacuzzi_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblJacuzzi')}}
...
{{--                                                         {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->jacuzzi && (strcmp($features->jacuzzi_description,'ندارد')==0) )
                                    <span id="myPopup9" class="">{{trans('messages.lblJacuzzi')}}</span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->tel && (strcmp($features->tel_description,'ندارد')==0) )
                                    <span id="myPopup10" class=""> {{trans('messages.lblTel')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->plumbing && (strcmp($features->plumbing_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblPlumbing')}}
                                ...
                                @elseif($features->plumbing && (strcmp($features->plumbing_description,'ندارد')==0) )
                                    <span id="myPopup11" class="">   {{trans('messages.lblPlumbing')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->electricity && (strcmp($features->electricity_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblElectricity')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->electricity && (strcmp($features->electricity_description,'ندارد')==0) )
                                    <span id="myPopup12" class="">  {{trans('messages.lblElectricity')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->lighting && (strcmp($features->lighting_description,'ندارد')!=0) )
                                    <span>{{trans('messages.lblLighting')}}
                                ...
                                @elseif($features->lighting && (strcmp($features->lighting_description,'ندارد')==0) )
                                    <span id="myPopup13">{{trans('messages.lblLighting')}}</span>
                                @else
                                    <span id="myPopup13"
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->cooling_system && (strcmp($features->cooling_system_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblCoolingSystem')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->cooling_system && (strcmp($features->cooling_system_description,'ندارد')==0) )
                                    <span id="myPopup14"
                                          class="">  {{trans('messages.lblCoolingSystem')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->heating_system && (strcmp($features->heating_system_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblHeatingSystem')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->heating_system && (strcmp($features->heating_system_description,'ندارد')==0) )
                                    <span id="myPopup15"
                                          class="">  {{trans('messages.lblHeatingSystem')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->sports_equipment && (strcmp($features->sports_equipment_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblSportsEquipment')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->sports_equipment && (strcmp($features->sports_equipment_description,'ندارد')==0) )
                                    <span id="myPopup16"
                                          class="">   {{trans('messages.lblSportsEquipment')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->pool_table && (strcmp($features->pool_table_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblPoolTable')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->pool_table && (strcmp($features->pool_table_description,'ندارد')==0) )
                                    <span id="myPopup17" class="">     {{trans('messages.lblPoolTable')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->volleyball_field && (strcmp($features->volleyball_field_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblVolleyballField')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->volleyball_field && (strcmp($features->volleyball_field_description,'ندارد')==0) )
                                    <span id="myPopup18"
                                          class="">     {{trans('messages.lblVolleyballField')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->football_field && (strcmp($features->football_field_description,'ندارد')!=0) )
                                    <span>  {{trans('messages.lblFootballField')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->football_field && (strcmp($features->football_field_description,'ندارد')==0) )
                                    <span id="myPopup19"
                                          class="">    {{trans('messages.lblFootballField')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->tennis_field && (strcmp($features->tennis_field_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblTennisField')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->tennis_field && (strcmp($features->tennis_field_description,'ندارد')==0) )
                                    <span id="myPopup20"
                                          class="">    {{trans('messages.lblTennisField')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->basketball_field && (strcmp($features->basketball_field_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblBasketballField')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->basketball_field && (strcmp($features->basketball_field_description,'ندارد')==0) )
                                    <span id="myPopup21"
                                          >    {{trans('messages.lblBasketballField')}}</span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->foosball && (strcmp($features->foosball_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblFoosball')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->foosball && (strcmp($features->foosball_description,'ندارد')==0) )
                                    <span id="myPopup22" class="">     {{trans('messages.lblFoosball')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->ping_pong && (strcmp($features->ping_pong_description,'ندارد')!=0) )
                                    <span>  {{trans('messages.lblPingPong')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->barbecue && (strcmp($features->barbecue_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblBarbecue')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->barbecue && (strcmp($features->barbecue_description,'ندارد')==0) )
                                    <span id="myPopup24" class="">  {{trans('messages.lblBarbecue')}} </span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->oven && (strcmp($features->oven_description,'ندارد')==0) )
                                    <span id="myPopup25" class="">  {{trans('messages.lblOven')}} </span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->macro && (strcmp($features->macro_description,'ندارد')==0) )
                                    <span id="myPopup26" class="">  {{trans('messages.lblMacro')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->refrigerator && (strcmp($features->refrigerator_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblRefrigerator')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->refrigerator && (strcmp($features->refrigerator_description,'ندارد')==0) )
                                    <span id="myPopup27"
                                          class="">  {{trans('messages.lblRefrigerator')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->vacuum_cleaner && (strcmp($features->vacuum_cleaner_description,'ندارد')!=0) )
                                    <span>   {{trans('messages.lblVacuumCleaner')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->vacuum_cleaner && (strcmp($features->vacuum_cleaner_description,'ندارد')==0) )
                                    <span id="myPopup28"
                                          class="">   {{trans('messages.lblVacuumCleaner')}} </span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->otto && (strcmp($features->otto_description,'ندارد')==0) )
                                    <span id="myPopup29" class="">   {{trans('messages.lblOtto')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->digital_receiver && (strcmp($features->digital_receiver_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblDigitalReceiver')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->digital_receiver && (strcmp($features->digital_receiver_description,'ندارد')==0) )
                                    <span id="myPopup30"
                                          class="">  {{trans('messages.lblDigitalReceiver')}} </span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->closet && (strcmp($features->closet_description,'ندارد')==0) )
                                    <span id="myPopup31" class="">  {{trans('messages.lblCloset')}} </span>
                                @else
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->drawer && (strcmp($features->drawer_description,'ندارد')==0) )
                                    <span id="myPopup32" class="">  {{trans('messages.lblDrawer')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->dining_table && (strcmp($features->dining_table_description,'ندارد')!=0) )
                                    <span>   {{trans('messages.lblDiningTable')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->dining_table && (strcmp($features->dining_table_description,'ندارد')==0) )
                                    <span id="myPopup33"
                                          class="">     {{trans('messages.lblDiningTable')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->furniture && (strcmp($features->furniture_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblFurniture')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->furniture && (strcmp($features->furniture_description,'ندارد')==0) )
                                    <span id="myPopup34"
                                          class="">     {{trans('messages.lblFurniture')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->television && (strcmp($features->television_description,'ندارد')!=0) )
                                    <span > {{trans('messages.lblTelevision')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->television && (strcmp($features->television_description,'ندارد')==0) )
                                    <span id="myPopup35"
                                          class="">     {{trans('messages.lblTelevision')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->washing_machine && (strcmp($features->washing_machine_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblWashingMachine')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->washing_machine && (strcmp($features->washing_machine_description,'ندارد')==0) )
                                    <span id="myPopup36"
                                          class="">      {{trans('messages.lblWashingMachine')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->hairdryer && (strcmp($features->hairdryer_description,'ندارد')!=0) )
                                    <span >  {{trans('messages.lblHairdryer')}}
...
{{--                                                     {{trans('messages.lblHave')}}--}}
                                ...
                                @elseif($features->hairdryer && (strcmp($features->hairdryer_description,'ندارد')==0) )
                                    <span id="myPopup37"
                                          class="">      {{trans('messages.lblHairdryer')}} </span>
                                @else
                            ...
                            <div class="col-sm-4">
                                ...
                                @if( $features->janitor && (strcmp($features->janitor_description,'ندارد')!=0) )
                                    <span> {{trans('messages.lblJanitor')}}
                                ...
                                @elseif($features->janitor && (strcmp($features->janitor_description,'ندارد')==0) )
                                    <span id="myPopup38" class="">      {{trans('messages.lblJanitor')}} </span>
                                @else
                ...
                <div class="page-section" id="contact">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4 class="widget-title" style="color: black">ثبت رزرو</h4>
                            <p style="margin-bottom: 3px"> در تقویم زیر، جدول برنامه ی باغ و همچنین قیمت برای رزور تمام روز در هر روز را مشاهده میکنید.</p>
                        </div>
                    </div>
                    ...
                    <div id="MeysamTemp" style="margin-top: 20px">
                        <form name="reserve_form" role="form" method="POST" onsubmit="return validateMyForm();"
                                            ...
                                            <fieldset>
                                                ...
                                                <script>
                                                    ...
                                                    function changeImageSelection() {
                                                        document.getElementById('final_cost').innerText =  'نامشخص';
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <input id="start_date_show" type="text"
                                                                   ...
                                                                   required title="تاریخ شروع"  autocomplete="off">
                                                    ...
                                                    <div class="form-group" id="form_ctr_02">
                                                        ...
                                                        <select id="shift_id_1" name="shift_id_1" onchange="calculateCost()" required>
                                                            <option value="-1"> {{trans('messages.txtChoose')}}</option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group" id="form_ctr_05" style="display: none">
                                                        <label for="shift_id_2"
                                                               style="display: block">{{trans('messages.lblShifts')}}</label>
                                                        <select id="shift_id_2" name="shift_id_2" onchange="calculateCost()"
                                                                ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~name="shift_id_2">
                                                            <option value="-1"> {{trans('messages.txtChoose')}}</option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            <div class="col-md-12 form-group" id="captchSection">
                                                <p style="text-align: center">
                                                    <input type="checkbox" id="chk_terms" name="chk_terms" required>
                                                    تایید می کنم که
                                                    <a target="_blank" href="{{url('/termsOfUse') }}"> شرایط
                                                        و
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div id="final_cost" style="text-align: center;font-size: large">
                                                    ...
                                                </div>
                                            </div>
                                            <div>
...
@section('page-js-script')
    <script type="text/javascript">
                ...
                if (containsObject(SelectedDay3, reserved_dates)) {
                    if (containsObject(SelectedDay3, reserved_dates).shift_id == "0") {
                        if (containsObject_second(SelectedDay3, reserved_dates).shift_id == "1") {
                            ...
                            swal({
                                type: 'warning',
                                title: 'توجه کنید که این تاریخ برای صبح رزرو شده است.بنابراین فقط مجاز به انتخاب بازه ی شب تا صبح می باشید'
                            })
                        }
                        ...
                        if (containsObject_second(SelectedDay3, reserved_dates).shift_id == "0") {
                            ...
                            swal({
                                type: 'warning',
                                title: 'توجه کنید که این تاریخ برای شب رزرو شده است.بنابراین فقط مجاز به انتخاب بازه ی صبح تا شب می باشید'
                            })
                        }
                    } else {
                        swal('تاریخ انتخابی پر است!');
        ...
        function calculateCost() {
            ...
            var startDayElement = document.getElementById('start_week_day_id');
            var startDayOfWeek = startDayElement.options[startDayElement.selectedIndex].value;

            // alert(startDayOfWeek);

            var startShiftElement = document.getElementById('shift_id_1');
            var startShift = startShiftElement.options[startShiftElement.selectedIndex].value;

            // alert('startShift:' + startShift);

            var reserveType = $("#reserved_kind");
            if(reserveType.val() == 1)
            {
                // alert('یک روز یا کمتر');
                cost = getCostForAday(startDayOfWeek, startShift);

                var i;
                for (i = 0; i < periodic_holidays.length; i++) {
                    if(periodic_holidays[i].day_of_week == startDayOfWeek)
                    {
                        swal({
                            type: 'warning',
                            title: 'تاریخ انتخاب شده غیر قابل قبول می باشد. لطفا تاریخ دیگری انتخاب نمایید.'
                        })
                    }
            ...
            {
                var endDayElement = document.getElementById('end_week_day_id');
                var endDayOfWeek = endDayElement.options[endDayElement.selectedIndex].value;
                ...
                var endShiftElement = document.getElementById('shift_id_2');
                var endShift = endShiftElement.options[endShiftElement.selectedIndex].value;

                // alert('endShift:' + endShift);

                // alert('چند روزه');

                cost = getCostForMultipleDays(startDayOfWeek,startShift,endDayOfWeek,endShift)
            }

            document.getElementById('final_cost').innerText ='قیمت نهایی: '+ (cost)+ ' تومان';

        }

        function getCostForMultipleDays(startDayOfWeek, startShift, endDayOfWeek, endShift) {
            // alert('dfd');
            var cost = 0;
            // alert('cost 1: ' + cost);

            cost += periodic_costs[startDayOfWeek].shifts[startShift].cost;
            cost += periodic_costs[endDayOfWeek].shifts[endShift].cost;

            // alert('cost 2: ' + cost);

            var startDayOfWeek = Number(startDayOfWeek);
            var endDayOfWeek = Number(endDayOfWeek);
            // alert('endDayOfWeek: ' + endDayOfWeek);
            var i = startDayOfWeek + 1;
            // alert('startDayOfWeek: ' + startDayOfWeek);
            if(i > 6)
            {
                i = 0;
            }
            ...
            while (true) {
                ...
                // alert('cost 4: ' + i);
                cost += periodic_costs[i].shifts[2].cost;
